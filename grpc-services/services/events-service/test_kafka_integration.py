#!/usr/bin/env python3
"""
Test script para verificar la integración de Kafka en el servicio de eventos
"""
...
def test_kafka_connection():
    ...
    try:
        logger.info("=== Test de Integración Kafka - Servicio de Eventos ===")
        ...
        test_message = {
            ...
            "servicio": "events-service"
        }
        
        success = kafka_client.publish_message("eventos-solidarios", test_message)
        if success:
        ...
        kafka_client.subscribe_to_topic("eventos-solidarios", test_handler)
