#!/usr/bin/env python3
"""
Test script para verificar la integración de Kafka en el servicio de inventario
"""
...
def test_kafka_connection():
    ...
    try:
        logger.info("=== Test de Integración Kafka - Servicio de Inventario ===")
        ...
        success = kafka_client.publish_message("oferta-donaciones", test_message)
        if success:
